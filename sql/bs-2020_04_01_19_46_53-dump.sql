...
INSERT INTO `course` VALUES (1,'在线学习系统',2);
...
CREATE TABLE `media` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='媒体文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (2,'sch','合肥工业大学','001','1','1','1'),(3,'sch','合肥工业大学','002','1','1','2');
...
-- Dump completed on 2020-04-01 19:46:53
