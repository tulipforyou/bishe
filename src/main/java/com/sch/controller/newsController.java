...
import com.sch.service.imageServiceImpl;
import com.sch.service.newsServiceImpl;
import com.sch.util.newsUtil;
...
//		}
	...
	public ModelAndView showNews2() {
		...
		try {
			mv = new ModelAndView("classContent");
	...
	public ModelAndView showNews3() {
		...
		try {
			mv = new ModelAndView("classPractice");
...
//
	...
	public String deleteData(String head) {
		ss.deleteNews(head);
		System.out.println("操作成功");
	...
	public ModelAndView showNews(String head) {
		ModelAndView mav=new ModelAndView("showNews");
		ArrayList<news> allNews = ss.getAllNews();
		mav.addObject("data",allNews);
		return mav;
