                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="grade1">
                            ...
                            选课管理 <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="row" items="${data}">
                    <tr scope="row ">
                        <td>
                            <label>
                                <input type="checkbox" class="checkbox" value="${row.no }" id="checkbox" name="checkbox"
                                       style="zoom:200%"/>
                                <span class="lbl"></span>
                            </label>
                        </td>
                ...
                <th colspan="5" style="text-align:right;">
                    <button type="button" class=" btn btn-secondary" id="delete">删除</button>
                </th>
                </tbody>
            </table>
...
<%--<div class="containt">
    ...
    <c:forEach var="row" items="${data}">
            <tr scope="row ">
                <td>
                    <label>
                        <input type="checkbox" class="checkbox" value="${row.no }" id="checkbox" name="checkbox" style="zoom:200%"/>
                        <span class="lbl"></span>
                    </label>
                </td>
                <td id="no">${row.no}</td>
    ...
    <th colspan="5" style="text-align:right;"><button type="button" class=" btn btn-secondary" id="delete">删除</button></th>
    </tbody>
</table>
</div>
...
<script src="js/grade1.js"></script>--%>
</body>
</html>